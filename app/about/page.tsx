    ...
    <main className="min-h-screen flex flex-col">
      ...
      <div className="bg-white py-20 flex-grow">
        <div className="container mx-auto px-4 max-w-4xl">
          <h1 className="text-4xl font-bold text-[#2D1B69] mb-8">About Saphala Self Prep</h1>
          <div className="prose prose-lg text-gray-600 max-w-none space-y-6">
            <p>
              Saphala Self Prep is more than just an educational platform; it's a dedicated partner in your academic success. Founded by educators and technologists, we understand the challenges students face in today's competitive environment.
            </p>
