...
/** Returns the fallback color for a given subject name, or null if unknown. */
...
/**
 * Converts a hex color string (e.g. "#2563EB") into the three tokens used
 * by subject folder UI: a light background, a full-saturation icon color,
