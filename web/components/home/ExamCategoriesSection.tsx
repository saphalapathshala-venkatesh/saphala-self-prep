...
export default function ExamCategoriesSection() {
  ...
  useEffect(() => {
    ...
    function update() {
      ...
      if (scrollable <= 0) { setThumb({ left: 0, width: 100 }); return; }
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-8">
          ...
          <p className="text-[#6B5CA5] max-w-xl mx-auto">
            Browse preparation options based on your target exam. Select a course and start with the learning path that fits you best.
          </p>
        </div>
          ...
          >
            <div
              ...
              style={{
                width: `${thumb.width}%`,
                left: `${thumb.left}%`,
                transition: isDragging ? "none" : "left 80ms ease, width 80ms ease",
              }}
            />
          </div>
        )}
