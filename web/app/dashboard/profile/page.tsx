...
export default async function ProfilePage() {
  ...
  // Count total submitted attempts for the profile summary
  const attemptCount = await prisma.attempt.count({
    where: { userId: user.id, status: "SUBMITTED" },
  });

  // XP total
  const xpAgg = await prisma.xpLedgerEntry.aggregate({
        ...
        <div className="bg-blue-50 border border-blue-100 rounded-xl p-4 flex gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-blue-600 leading-relaxed">
              You can view your profile details here. Editing your name, state, and
              other fields will be available in a future update. For urgent changes,
